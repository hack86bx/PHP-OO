...
class SecondeClass{
    ...
    */
    ...
    public int $param3; // propiété typée 
    ...
    /*
    Constantes 
    Ce sont des variables non modifiables qui doivent être initialisées avec 
    leur valeur. Les règles de nommage sont en UPPER_SNAKE_CASE
    La visibilité par défaut est publique 
    */
